...
const Footer = () => {
  ...
  return (
    <div className={`lg:flex justify-between items-center lg:px-20 py-10 ${!theme?"bg-[#EBF2FA]":"bg-[#064789]"}`}>
        <div>
        ...
        <div className={`lg:flex justify-between items-center gap-5 text-center lg:text-left ${theme?"text-[#EBF2FA]":"text-[#064789]"} `} >
            <Link to={`tel:+917073271758`} className=" ">
            +91 7073271758
            </Link>
            <Link to={`mailto:abhay0480sharma@gmail.com`} className="  block lg:flex">
